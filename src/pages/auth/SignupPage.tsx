      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6 sm:p-12 bg-white">
        <div className="w-full max-w-md space-y-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <select
                  id="role"
                  className={`block w-full pl-11 pr-4 py-3.5 bg-slate-50 border rounded-xl outline-none transition-all text-sm appearance-none ${
                    errors.role
                      ? "border-red-500 focus:ring-red-200"
                      : "border-slate-200 focus:ring-[#1c6bf2]/20 focus:border-[#1c6bf2]"
                  }`}
                ...
                >
                  ...
                  <option value="SAMPLING_HEAD">SAMPLING HEAD</option>
          ...
          <div className="text-sm text-center">
            ...
            <Link to={"/auth/signin"} className="text-[#1c6bf2]">
              Sign in
            </Link>
          </div>
        </div>
